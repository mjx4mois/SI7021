...
void  EXAMPLE_SI7021(void)
{
	...
	CHAR8U lcd_char_data[5]={0};
		...
		if(SI7021_reset_once==1)    
		{
			 ...
			 if(status==0)
			 { 
			 	printf(" RESET SI7021 success!\r\n");
			}
			else
			{
				printf(" RESET SI7021 fail!\r\n");
			}
		...
		if(status==0) 
		{
			printf(" INITIAL SI7021 success!\r\n");
		}
		else
		{
			printf(" INITIAL SI7021 fail!\r\n");
		}
		...
		{		
			...
			{
				printf(" SI7021 Battery 1.8V<VDD<1.9v	VDD is not good!\r\n");
			}
			
			if(battery_status==0x00)
			{
				printf(" SI7021 Battery VDD>1.9v		VDD OK!\r\n");
			}
		}
		else 		
		{
		...
		while(1)
		{
			...
			if(status!=0) 
			{
				printf(" read SI7021 temperature data fail\r\n");
			}
			...
			if(status!=0) 
			{
				printf(" read SI7021 humidity data fail\r\n");
			}
